...
mixin _$PaginationState<T> {
 ...
 List<T> get items; int get currentPage; bool get hasMore; bool get isMoreLoading;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(items),currentPage,hasMore,isMoreLoading);

@override
String toString() {
  return 'PaginationState<$T>(items: $items, currentPage: $currentPage, hasMore: $hasMore, isMoreLoading: $isMoreLoading)';
}
...
@useResult
$Res call({
 List<T> items, int currentPage, bool hasMore, bool isMoreLoading
});
...
/// Create a copy of PaginationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? currentPage = null,Object? hasMore = null,Object? isMoreLoading = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<T> items,  int currentPage,  bool hasMore,  bool isMoreLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginationState() when $default != null:
return $default(_that.items,_that.currentPage,_that.hasMore,_that.isMoreLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<T> items,  int currentPage,  bool hasMore,  bool isMoreLoading)  $default,) {final _that = this;
switch (_that) {
case _PaginationState():
return $default(_that.items,_that.currentPage,_that.hasMore,_that.isMoreLoading);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<T> items,  int currentPage,  bool hasMore,  bool isMoreLoading)?  $default,) {final _that = this;
switch (_that) {
case _PaginationState() when $default != null:
return $default(_that.items,_that.currentPage,_that.hasMore,_that.isMoreLoading);case _:
  return null;
...
class _PaginationState<T> implements PaginationState<T> {
  const _PaginationState({final  List<T> items = const [], this.currentPage = 1, this.hasMore = true, this.isMoreLoading = false}): _items = items;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_items),currentPage,hasMore,isMoreLoading);
...
/// Create a copy of PaginationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? items = null,Object? currentPage = null,Object? hasMore = null,Object? isMoreLoading = null,}) {
