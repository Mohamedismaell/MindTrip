...
mixin _$AiPlannerState {
 ...
 String? get tripId; GeneratedPlanEntity? get generatedPlan; CollectedPlannerDataEntity get collectedData; String? get savedTripId; AiPlannerStatus get status; String get errorMessage; int get currentPage; String get sessionId; int get maxReachedPage; String? get selectedDestination; String get destinationQuery; DateTime? get tripStart; DateTime? get tripEnd; int get adults; int get children; BudgetTierModel? get selectedBudget; String get customBudget; DateTime? get visibleMonth; List<String> get selectedInterests; DateTime get focusedDay;
...
/// Create a copy of AiPlannerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tripId = freezed,Object? generatedPlan = freezed,Object? collectedData = null,Object? savedTripId = freezed,Object? status = null,Object? errorMessage = null,Object? currentPage = null,Object? sessionId = null,Object? maxReachedPage = null,Object? selectedDestination = freezed,Object? destinationQuery = null,Object? tripStart = freezed,Object? tripEnd = freezed,Object? adults = null,Object? children = null,Object? selectedBudget = freezed,Object? customBudget = null,Object? visibleMonth = freezed,Object? selectedInterests = null,Object? focusedDay = null,}) {
...
as GeneratedPlanEntity?,collectedData: null == collectedData ? _self.collectedData : collectedData // ignore: cast_nullable_to_non_nullable
as CollectedPlannerDataEntity,savedTripId: freezed == savedTripId ? _self.savedTripId : savedTripId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? tripId,  GeneratedPlanEntity? generatedPlan,  CollectedPlannerDataEntity collectedData,  String? savedTripId,  AiPlannerStatus status,  String errorMessage,  int currentPage,  String sessionId,  int maxReachedPage,  String? selectedDestination,  String destinationQuery,  DateTime? tripStart,  DateTime? tripEnd,  int adults,  int children,  BudgetTierModel? selectedBudget,  String customBudget,  DateTime? visibleMonth,  List<String> selectedInterests,  DateTime focusedDay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiPlannerState() when $default != null:
return $default(_that.tripId,_that.generatedPlan,_that.collectedData,_that.savedTripId,_that.status,_that.errorMessage,_that.currentPage,_that.sessionId,_that.maxReachedPage,_that.selectedDestination,_that.destinationQuery,_that.tripStart,_that.tripEnd,_that.adults,_that.children,_that.selectedBudget,_that.customBudget,_that.visibleMonth,_that.selectedInterests,_that.focusedDay);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? tripId,  GeneratedPlanEntity? generatedPlan,  CollectedPlannerDataEntity collectedData,  String? savedTripId,  AiPlannerStatus status,  String errorMessage,  int currentPage,  String sessionId,  int maxReachedPage,  String? selectedDestination,  String destinationQuery,  DateTime? tripStart,  DateTime? tripEnd,  int adults,  int children,  BudgetTierModel? selectedBudget,  String customBudget,  DateTime? visibleMonth,  List<String> selectedInterests,  DateTime focusedDay)  $default,) {final _that = this;
switch (_that) {
case _AiPlannerState():
return $default(_that.tripId,_that.generatedPlan,_that.collectedData,_that.savedTripId,_that.status,_that.errorMessage,_that.currentPage,_that.sessionId,_that.maxReachedPage,_that.selectedDestination,_that.destinationQuery,_that.tripStart,_that.tripEnd,_that.adults,_that.children,_that.selectedBudget,_that.customBudget,_that.visibleMonth,_that.selectedInterests,_that.focusedDay);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? tripId,  GeneratedPlanEntity? generatedPlan,  CollectedPlannerDataEntity collectedData,  String? savedTripId,  AiPlannerStatus status,  String errorMessage,  int currentPage,  String sessionId,  int maxReachedPage,  String? selectedDestination,  String destinationQuery,  DateTime? tripStart,  DateTime? tripEnd,  int adults,  int children,  BudgetTierModel? selectedBudget,  String customBudget,  DateTime? visibleMonth,  List<String> selectedInterests,  DateTime focusedDay)?  $default,) {final _that = this;
switch (_that) {
case _AiPlannerState() when $default != null:
return $default(_that.tripId,_that.generatedPlan,_that.collectedData,_that.savedTripId,_that.status,_that.errorMessage,_that.currentPage,_that.sessionId,_that.maxReachedPage,_that.selectedDestination,_that.destinationQuery,_that.tripStart,_that.tripEnd,_that.adults,_that.children,_that.selectedBudget,_that.customBudget,_that.visibleMonth,_that.selectedInterests,_that.focusedDay);case _:
  return null;
...
class _AiPlannerState extends AiPlannerState {
  const _AiPlannerState({this.tripId, this.generatedPlan, this.collectedData = const CollectedPlannerDataEntity(), this.savedTripId, this.status = AiPlannerStatus.initial, this.errorMessage = '', this.currentPage = 0, this.sessionId = '', this.maxReachedPage = 0, this.selectedDestination, this.destinationQuery = '', this.tripStart, this.tripEnd, this.adults = 0, this.children = 0, this.selectedBudget, this.customBudget = '', this.visibleMonth, final  List<String> selectedInterests = const <String>[], required this.focusedDay}): _selectedInterests = selectedInterests,super._();
  

@override final  String? tripId;
@override final  GeneratedPlanEntity? generatedPlan;
@override@JsonKey() final  CollectedPlannerDataEntity collectedData;
@override final  String? savedTripId;
...
@override
int get hashCode => Object.hashAll([runtimeType,tripId,generatedPlan,collectedData,savedTripId,status,errorMessage,currentPage,sessionId,maxReachedPage,selectedDestination,destinationQuery,tripStart,tripEnd,adults,children,selectedBudget,customBudget,visibleMonth,const DeepCollectionEquality().hash(_selectedInterests),focusedDay]);
...
/// Create a copy of AiPlannerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tripId = freezed,Object? generatedPlan = freezed,Object? collectedData = null,Object? savedTripId = freezed,Object? status = null,Object? errorMessage = null,Object? currentPage = null,Object? sessionId = null,Object? maxReachedPage = null,Object? selectedDestination = freezed,Object? destinationQuery = null,Object? tripStart = freezed,Object? tripEnd = freezed,Object? adults = null,Object? children = null,Object? selectedBudget = freezed,Object? customBudget = null,Object? visibleMonth = freezed,Object? selectedInterests = null,Object? focusedDay = null,}) {
