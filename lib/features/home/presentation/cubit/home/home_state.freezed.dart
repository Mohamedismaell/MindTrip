...
// @Default('') String recommendedPlacesError,
 HomeDataStatus get tourPackagesStatus; List<TourPackageEntity> get tourPackages; String get tourPackagesError; HomeDataStatus get plannerPreviewsStatus; List<PlannerPreviewEntity> get plannerPreviews; String get plannerPreviewsError;//hidden gems
...
@override
int get hashCode => Object.hashAll([runtimeType,bannersStatus,const DeepCollectionEquality().hash(banners),bannersError,popularPlacesStatus,popularPlaces,popularPlacesError,categoryPlacesStatus,categoryPlaces,selectedCategory,categoryPlacesError,tourPackagesStatus,const DeepCollectionEquality().hash(tourPackages),tourPackagesError,plannerPreviewsStatus,const DeepCollectionEquality().hash(plannerPreviews),plannerPreviewsError,hiddenGemsStatus,hiddenGems,hiddenGemsError,const DeepCollectionEquality().hash(homeCategories)]);
...
@useResult
$Res call({
 HomeDataStatus bannersStatus, List<BannerEntity> banners, String bannersError, HomeDataStatus popularPlacesStatus, PaginationState<PlaceEntity> popularPlaces, String popularPlacesError, HomeDataStatus categoryPlacesStatus, PaginationState<PlaceEntity> categoryPlaces, PlaceCategory selectedCategory, String categoryPlacesError, HomeDataStatus tourPackagesStatus, List<TourPackageEntity> tourPackages, String tourPackagesError, HomeDataStatus plannerPreviewsStatus, List<PlannerPreviewEntity> plannerPreviews, String plannerPreviewsError, HomeDataStatus hiddenGemsStatus, PaginationState<PlaceEntity> hiddenGems, String hiddenGemsError, List<PlaceCategory> homeCategories
});
...
@override
int get hashCode => Object.hashAll([runtimeType,bannersStatus,const DeepCollectionEquality().hash(_banners),bannersError,popularPlacesStatus,popularPlaces,popularPlacesError,categoryPlacesStatus,categoryPlaces,selectedCategory,categoryPlacesError,tourPackagesStatus,const DeepCollectionEquality().hash(_tourPackages),tourPackagesError,plannerPreviewsStatus,const DeepCollectionEquality().hash(_plannerPreviews),plannerPreviewsError,hiddenGemsStatus,hiddenGems,hiddenGemsError,const DeepCollectionEquality().hash(_homeCategories)]);
