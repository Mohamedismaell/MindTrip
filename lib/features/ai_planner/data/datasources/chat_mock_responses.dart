...
class ChatMockResponses {
  ...
  static const Map<String, List<String>> keywordMap = {
    'destination': ['destination', 'where', 'place', 'visit', 'go', 'trip', 'plan'],
    'hotel': ['hotel', 'stay', 'accommodation', 'resort', 'hostel', 'room'],
    'food': ['food', 'eat', 'restaurant', 'cuisine', 'meal', 'dinner', 'lunch', 'breakfast'],
    'activity': ['do', 'activity', 'activities', 'things', 'attraction', 'explore', 'see', 'tour'],
    'budget': ['budget', 'cost', 'price', 'cheap', 'expensive', 'money', 'afford'],
    'transport': ['transport', 'travel', 'bus', 'taxi', 'uber', 'flight', 'train', 'car'],
    'weather': ['weather', 'climate', 'temperature', 'hot', 'cold', 'rain', 'sun'],
  };
