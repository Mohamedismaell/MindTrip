...
@override
int get hashCode => Object.hash(runtimeType,bannersStatus,const DeepCollectionEquality().hash(banners),bannersError,popularPlacesStatus,popularPlaces,popularPlacesError,recommendedPlacesStatus,const DeepCollectionEquality().hash(recommendedPlaces),recommendedPlacesError,tourPackagesStatus,const DeepCollectionEquality().hash(tourPackages),tourPackagesError,plannerPreviewsStatus,const DeepCollectionEquality().hash(plannerPreviews),plannerPreviewsError);

@override
String toString() {
  return 'HomeState(bannersStatus: $bannersStatus, banners: $banners, bannersError: $bannersError, popularPlacesStatus: $popularPlacesStatus, popularPlaces: $popularPlaces, popularPlacesError: $popularPlacesError, recommendedPlacesStatus: $recommendedPlacesStatus, recommendedPlaces: $recommendedPlaces, recommendedPlacesError: $recommendedPlacesError, tourPackagesStatus: $tourPackagesStatus, tourPackages: $tourPackages, tourPackagesError: $tourPackagesError, plannerPreviewsStatus: $plannerPreviewsStatus, plannerPreviews: $plannerPreviews, plannerPreviewsError: $plannerPreviewsError)';
}
...
@useResult
$Res call({
 HomeDataStatus bannersStatus, List<BannerEntity> banners, String bannersError, HomeDataStatus popularPlacesStatus, PaginationState<PlaceEntity> popularPlaces, String popularPlacesError, HomeDataStatus recommendedPlacesStatus, List<PlaceEntity> recommendedPlaces, String recommendedPlacesError, HomeDataStatus tourPackagesStatus, List<TourPackageEntity> tourPackages, String tourPackagesError, HomeDataStatus plannerPreviewsStatus, List<PlannerPreviewEntity> plannerPreviews, String plannerPreviewsError
});
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? bannersStatus = null,Object? banners = null,Object? bannersError = null,Object? popularPlacesStatus = null,Object? popularPlaces = null,Object? popularPlacesError = null,Object? recommendedPlacesStatus = null,Object? recommendedPlaces = null,Object? recommendedPlacesError = null,Object? tourPackagesStatus = null,Object? tourPackages = null,Object? tourPackagesError = null,Object? plannerPreviewsStatus = null,Object? plannerPreviews = null,Object? plannerPreviewsError = null,}) {
...
as String,recommendedPlacesStatus: null == recommendedPlacesStatus ? _self.recommendedPlacesStatus : recommendedPlacesStatus // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( HomeDataStatus bannersStatus,  List<BannerEntity> banners,  String bannersError,  HomeDataStatus popularPlacesStatus,  PaginationState<PlaceEntity> popularPlaces,  String popularPlacesError,  HomeDataStatus recommendedPlacesStatus,  List<PlaceEntity> recommendedPlaces,  String recommendedPlacesError,  HomeDataStatus tourPackagesStatus,  List<TourPackageEntity> tourPackages,  String tourPackagesError,  HomeDataStatus plannerPreviewsStatus,  List<PlannerPreviewEntity> plannerPreviews,  String plannerPreviewsError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeState() when $default != null:
return $default(_that.bannersStatus,_that.banners,_that.bannersError,_that.popularPlacesStatus,_that.popularPlaces,_that.popularPlacesError,_that.recommendedPlacesStatus,_that.recommendedPlaces,_that.recommendedPlacesError,_that.tourPackagesStatus,_that.tourPackages,_that.tourPackagesError,_that.plannerPreviewsStatus,_that.plannerPreviews,_that.plannerPreviewsError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( HomeDataStatus bannersStatus,  List<BannerEntity> banners,  String bannersError,  HomeDataStatus popularPlacesStatus,  PaginationState<PlaceEntity> popularPlaces,  String popularPlacesError,  HomeDataStatus recommendedPlacesStatus,  List<PlaceEntity> recommendedPlaces,  String recommendedPlacesError,  HomeDataStatus tourPackagesStatus,  List<TourPackageEntity> tourPackages,  String tourPackagesError,  HomeDataStatus plannerPreviewsStatus,  List<PlannerPreviewEntity> plannerPreviews,  String plannerPreviewsError)  $default,) {final _that = this;
switch (_that) {
case _HomeState():
return $default(_that.bannersStatus,_that.banners,_that.bannersError,_that.popularPlacesStatus,_that.popularPlaces,_that.popularPlacesError,_that.recommendedPlacesStatus,_that.recommendedPlaces,_that.recommendedPlacesError,_that.tourPackagesStatus,_that.tourPackages,_that.tourPackagesError,_that.plannerPreviewsStatus,_that.plannerPreviews,_that.plannerPreviewsError);case _:
  throw StateError('Unexpected subclass');
...
class _HomeState implements HomeState {
  const _HomeState({this.bannersStatus = HomeDataStatus.initial, final  List<BannerEntity> banners = const [], this.bannersError = '', this.popularPlacesStatus = HomeDataStatus.initial, this.popularPlaces = const PaginationState<PlaceEntity>(), this.popularPlacesError = '', this.recommendedPlacesStatus = HomeDataStatus.initial, final  List<PlaceEntity> recommendedPlaces = const [], this.recommendedPlacesError = '', this.tourPackagesStatus = HomeDataStatus.initial, final  List<TourPackageEntity> tourPackages = const [], this.tourPackagesError = '', this.plannerPreviewsStatus = HomeDataStatus.initial, final  List<PlannerPreviewEntity> plannerPreviews = const [], this.plannerPreviewsError = ''}): _banners = banners,_recommendedPlaces = recommendedPlaces,_tourPackages = tourPackages,_plannerPreviews = plannerPreviews;
...
@override
int get hashCode => Object.hash(runtimeType,bannersStatus,const DeepCollectionEquality().hash(_banners),bannersError,popularPlacesStatus,popularPlaces,popularPlacesError,recommendedPlacesStatus,const DeepCollectionEquality().hash(_recommendedPlaces),recommendedPlacesError,tourPackagesStatus,const DeepCollectionEquality().hash(_tourPackages),tourPackagesError,plannerPreviewsStatus,const DeepCollectionEquality().hash(_plannerPreviews),plannerPreviewsError);
...
@override $PaginationStateCopyWith<PlaceEntity, $Res> get popularPlaces;
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? bannersStatus = null,Object? banners = null,Object? bannersError = null,Object? popularPlacesStatus = null,Object? popularPlaces = null,Object? popularPlacesError = null,Object? recommendedPlacesStatus = null,Object? recommendedPlaces = null,Object? recommendedPlacesError = null,Object? tourPackagesStatus = null,Object? tourPackages = null,Object? tourPackagesError = null,Object? plannerPreviewsStatus = null,Object? plannerPreviews = null,Object? plannerPreviewsError = null,}) {
