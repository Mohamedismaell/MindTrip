...
@HiveField(0)@JsonKey(name: 'place_id') String get placeId;@HiveField(1) String get name;@HiveField(2) String? get city;@HiveField(3)@JsonKey(name: 'city_en') String? get cityEn;@HiveField(4) List<String>? get interests;@HiveField(5) String? get category;/// Price per person
@HiveField(6)@JsonKey(fromJson: _toDouble) double? get price;/// Total estimated cost
@HiveField(7)@JsonKey(fromJson: _toDouble) double? get cost;@HiveField(8)@JsonKey(fromJson: _toDouble) double? get rating;@HiveField(9)@JsonKey(name: 'reviews_count') int? get reviewsCount;@HiveField(10) String? get address;@HiveField(11) String? get description;@HiveField(12)@JsonKey(name: 'photo_url') String? get photoUrl;@HiveField(13)@JsonKey(name: 'image_urls') List<String>? get imageUrls;@HiveField(14)@JsonKey(name: 'opening_hours') String? get openingHours;@HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable) double get lat;@HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable) double get lng;@HiveField(17)@JsonKey(name: 'is_hidden_gem') bool get isHiddenGem;@HiveField(18)@JsonKey(name: 'maps_url') String? get mapsUrl;// New fields from sample
...
@useResult
$Res call({
@HiveField(0)@JsonKey(name: 'place_id') String placeId,@HiveField(1) String name,@HiveField(2) String? city,@HiveField(3)@JsonKey(name: 'city_en') String? cityEn,@HiveField(4) List<String>? interests,@HiveField(5) String? category,@HiveField(6)@JsonKey(fromJson: _toDouble) double? price,@HiveField(7)@JsonKey(fromJson: _toDouble) double? cost,@HiveField(8)@JsonKey(fromJson: _toDouble) double? rating,@HiveField(9)@JsonKey(name: 'reviews_count') int? reviewsCount,@HiveField(10) String? address,@HiveField(11) String? description,@HiveField(12)@JsonKey(name: 'photo_url') String? photoUrl,@HiveField(13)@JsonKey(name: 'image_urls') List<String>? imageUrls,@HiveField(14)@JsonKey(name: 'opening_hours') String? openingHours,@HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable) double lat,@HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable) double lng,@HiveField(17)@JsonKey(name: 'is_hidden_gem') bool isHiddenGem,@HiveField(18)@JsonKey(name: 'maps_url') String? mapsUrl,@HiveField(19) String? day,@HiveField(20)@JsonKey(name: 'is_opened') String? isOpened,@HiveField(21) String? type
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: 'place_id')  String placeId, @HiveField(1)  String name, @HiveField(2)  String? city, @HiveField(3)@JsonKey(name: 'city_en')  String? cityEn, @HiveField(4)  List<String>? interests, @HiveField(5)  String? category, @HiveField(6)@JsonKey(fromJson: _toDouble)  double? price, @HiveField(7)@JsonKey(fromJson: _toDouble)  double? cost, @HiveField(8)@JsonKey(fromJson: _toDouble)  double? rating, @HiveField(9)@JsonKey(name: 'reviews_count')  int? reviewsCount, @HiveField(10)  String? address, @HiveField(11)  String? description, @HiveField(12)@JsonKey(name: 'photo_url')  String? photoUrl, @HiveField(13)@JsonKey(name: 'image_urls')  List<String>? imageUrls, @HiveField(14)@JsonKey(name: 'opening_hours')  String? openingHours, @HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable)  double lat, @HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable)  double lng, @HiveField(17)@JsonKey(name: 'is_hidden_gem')  bool isHiddenGem, @HiveField(18)@JsonKey(name: 'maps_url')  String? mapsUrl, @HiveField(19)  String? day, @HiveField(20)@JsonKey(name: 'is_opened')  String? isOpened, @HiveField(21)  String? type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaceModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: 'place_id')  String placeId, @HiveField(1)  String name, @HiveField(2)  String? city, @HiveField(3)@JsonKey(name: 'city_en')  String? cityEn, @HiveField(4)  List<String>? interests, @HiveField(5)  String? category, @HiveField(6)@JsonKey(fromJson: _toDouble)  double? price, @HiveField(7)@JsonKey(fromJson: _toDouble)  double? cost, @HiveField(8)@JsonKey(fromJson: _toDouble)  double? rating, @HiveField(9)@JsonKey(name: 'reviews_count')  int? reviewsCount, @HiveField(10)  String? address, @HiveField(11)  String? description, @HiveField(12)@JsonKey(name: 'photo_url')  String? photoUrl, @HiveField(13)@JsonKey(name: 'image_urls')  List<String>? imageUrls, @HiveField(14)@JsonKey(name: 'opening_hours')  String? openingHours, @HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable)  double lat, @HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable)  double lng, @HiveField(17)@JsonKey(name: 'is_hidden_gem')  bool isHiddenGem, @HiveField(18)@JsonKey(name: 'maps_url')  String? mapsUrl, @HiveField(19)  String? day, @HiveField(20)@JsonKey(name: 'is_opened')  String? isOpened, @HiveField(21)  String? type)  $default,) {final _that = this;
switch (_that) {
case _PlaceModel():
return $default(_that.placeId,_that.name,_that.city,_that.cityEn,_that.interests,_that.category,_that.price,_that.cost,_that.rating,_that.reviewsCount,_that.address,_that.description,_that.photoUrl,_that.imageUrls,_that.openingHours,_that.lat,_that.lng,_that.isHiddenGem,_that.mapsUrl,_that.day,_that.isOpened,_that.type);case _:
  throw StateError('Unexpected subclass');
...
class _PlaceModel extends PlaceModel {
  const _PlaceModel({@HiveField(0)@JsonKey(name: 'place_id') required this.placeId, @HiveField(1) required this.name, @HiveField(2) this.city, @HiveField(3)@JsonKey(name: 'city_en') this.cityEn, @HiveField(4) final  List<String>? interests, @HiveField(5) this.category, @HiveField(6)@JsonKey(fromJson: _toDouble) this.price, @HiveField(7)@JsonKey(fromJson: _toDouble) this.cost, @HiveField(8)@JsonKey(fromJson: _toDouble) this.rating, @HiveField(9)@JsonKey(name: 'reviews_count') this.reviewsCount, @HiveField(10) this.address, @HiveField(11) this.description, @HiveField(12)@JsonKey(name: 'photo_url') this.photoUrl, @HiveField(13)@JsonKey(name: 'image_urls') final  List<String>? imageUrls, @HiveField(14)@JsonKey(name: 'opening_hours') this.openingHours, @HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable) this.lat = 0.0, @HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable) this.lng = 0.0, @HiveField(17)@JsonKey(name: 'is_hidden_gem') this.isHiddenGem = false, @HiveField(18)@JsonKey(name: 'maps_url') this.mapsUrl, @HiveField(19) this.day, @HiveField(20)@JsonKey(name: 'is_opened') this.isOpened, @HiveField(21) this.type}): _interests = interests,_imageUrls = imageUrls,super._();
...
@override@HiveField(4) List<String>? get interests {
...
@override@HiveField(13)@JsonKey(name: 'image_urls') List<String>? get imageUrls {
