...
@override
int get hashCode => Object.hash(runtimeType,bannersStatus,const DeepCollectionEquality().hash(banners),bannersError,popularPlacesStatus,const DeepCollectionEquality().hash(popularPlaces),popularPlacesError,recommendedPlacesStatus,const DeepCollectionEquality().hash(recommendedPlaces),recommendedPlacesError,tourPackagesStatus,const DeepCollectionEquality().hash(tourPackages),tourPackagesError,plannerPreviewsStatus,const DeepCollectionEquality().hash(plannerPreviews),plannerPreviewsError);
...
@useResult
$Res call({
 HomeDataStatus bannersStatus, List<BannerEntity> banners, String bannersError, HomeDataStatus popularPlacesStatus, List<PlaceEntity> popularPlaces, String popularPlacesError, HomeDataStatus recommendedPlacesStatus, List<PlaceEntity> recommendedPlaces, String recommendedPlacesError, HomeDataStatus tourPackagesStatus, List<TourPackageEntity> tourPackages, String tourPackagesError, HomeDataStatus plannerPreviewsStatus, List<PlannerPreviewEntity> plannerPreviews, String plannerPreviewsError
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( HomeDataStatus bannersStatus,  List<BannerEntity> banners,  String bannersError,  HomeDataStatus popularPlacesStatus,  List<PlaceEntity> popularPlaces,  String popularPlacesError,  HomeDataStatus recommendedPlacesStatus,  List<PlaceEntity> recommendedPlaces,  String recommendedPlacesError,  HomeDataStatus tourPackagesStatus,  List<TourPackageEntity> tourPackages,  String tourPackagesError,  HomeDataStatus plannerPreviewsStatus,  List<PlannerPreviewEntity> plannerPreviews,  String plannerPreviewsError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( HomeDataStatus bannersStatus,  List<BannerEntity> banners,  String bannersError,  HomeDataStatus popularPlacesStatus,  List<PlaceEntity> popularPlaces,  String popularPlacesError,  HomeDataStatus recommendedPlacesStatus,  List<PlaceEntity> recommendedPlaces,  String recommendedPlacesError,  HomeDataStatus tourPackagesStatus,  List<TourPackageEntity> tourPackages,  String tourPackagesError,  HomeDataStatus plannerPreviewsStatus,  List<PlannerPreviewEntity> plannerPreviews,  String plannerPreviewsError)  $default,) {final _that = this;
switch (_that) {
case _HomeState():
return $default(_that.bannersStatus,_that.banners,_that.bannersError,_that.popularPlacesStatus,_that.popularPlaces,_that.popularPlacesError,_that.recommendedPlacesStatus,_that.recommendedPlaces,_that.recommendedPlacesError,_that.tourPackagesStatus,_that.tourPackages,_that.tourPackagesError,_that.plannerPreviewsStatus,_that.plannerPreviews,_that.plannerPreviewsError);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hash(runtimeType,bannersStatus,const DeepCollectionEquality().hash(_banners),bannersError,popularPlacesStatus,const DeepCollectionEquality().hash(_popularPlaces),popularPlacesError,recommendedPlacesStatus,const DeepCollectionEquality().hash(_recommendedPlaces),recommendedPlacesError,tourPackagesStatus,const DeepCollectionEquality().hash(_tourPackages),tourPackagesError,plannerPreviewsStatus,const DeepCollectionEquality().hash(_plannerPreviews),plannerPreviewsError);
