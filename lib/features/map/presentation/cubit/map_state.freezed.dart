...
mixin _$MapState {
 ...
 List<MapAnnotationEntry> get annotations; PlaceModel? get selectedPlace; GooglePlaceEntity? get selectedGooglePlace; List<String> get selectedPlacePhotoUrls; bool get isBottomSheetVisible; bool get isLocationGranted; bool get clearSelectedPlace; bool get clearSelectedGooglePlace; bool get clearFlyToLocation; double? get flyToLat; double? get flyToLng;/// Trip days passed from trip‐details; null when map is opened standalone.
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(annotations),selectedPlace,selectedGooglePlace,const DeepCollectionEquality().hash(selectedPlacePhotoUrls),isBottomSheetVisible,isLocationGranted,clearSelectedPlace,clearSelectedGooglePlace,clearFlyToLocation,flyToLat,flyToLng,const DeepCollectionEquality().hash(tripDays),selectedDayIndex);

@override
String toString() {
  return 'MapState(annotations: $annotations, selectedPlace: $selectedPlace, selectedGooglePlace: $selectedGooglePlace, selectedPlacePhotoUrls: $selectedPlacePhotoUrls, isBottomSheetVisible: $isBottomSheetVisible, isLocationGranted: $isLocationGranted, clearSelectedPlace: $clearSelectedPlace, clearSelectedGooglePlace: $clearSelectedGooglePlace, clearFlyToLocation: $clearFlyToLocation, flyToLat: $flyToLat, flyToLng: $flyToLng, tripDays: $tripDays, selectedDayIndex: $selectedDayIndex)';
}
...
@useResult
$Res call({
 List<MapAnnotationEntry> annotations, PlaceModel? selectedPlace, GooglePlaceEntity? selectedGooglePlace, List<String> selectedPlacePhotoUrls, bool isBottomSheetVisible, bool isLocationGranted, bool clearSelectedPlace, bool clearSelectedGooglePlace, bool clearFlyToLocation, double? flyToLat, double? flyToLng, List<TripDay>? tripDays, int? selectedDayIndex
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<MapAnnotationEntry> annotations,  PlaceModel? selectedPlace,  GooglePlaceEntity? selectedGooglePlace,  List<String> selectedPlacePhotoUrls,  bool isBottomSheetVisible,  bool isLocationGranted,  bool clearSelectedPlace,  bool clearSelectedGooglePlace,  bool clearFlyToLocation,  double? flyToLat,  double? flyToLng,  List<TripDay>? tripDays,  int? selectedDayIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MapState() when $default != null:
return $default(_that.annotations,_that.selectedPlace,_that.selectedGooglePlace,_that.selectedPlacePhotoUrls,_that.isBottomSheetVisible,_that.isLocationGranted,_that.clearSelectedPlace,_that.clearSelectedGooglePlace,_that.clearFlyToLocation,_that.flyToLat,_that.flyToLng,_that.tripDays,_that.selectedDayIndex);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<MapAnnotationEntry> annotations,  PlaceModel? selectedPlace,  GooglePlaceEntity? selectedGooglePlace,  List<String> selectedPlacePhotoUrls,  bool isBottomSheetVisible,  bool isLocationGranted,  bool clearSelectedPlace,  bool clearSelectedGooglePlace,  bool clearFlyToLocation,  double? flyToLat,  double? flyToLng,  List<TripDay>? tripDays,  int? selectedDayIndex)  $default,) {final _that = this;
switch (_that) {
case _MapState():
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_annotations),selectedPlace,selectedGooglePlace,const DeepCollectionEquality().hash(_selectedPlacePhotoUrls),isBottomSheetVisible,isLocationGranted,clearSelectedPlace,clearSelectedGooglePlace,clearFlyToLocation,flyToLat,flyToLng,const DeepCollectionEquality().hash(_tripDays),selectedDayIndex);
