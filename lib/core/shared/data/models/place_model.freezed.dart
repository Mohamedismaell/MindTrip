...
@HiveField(19)@JsonKey(fromJson: _toString) String? get day;@HiveField(20)@JsonKey(name: 'is_opened', fromJson: _toString) String? get isOpened;@HiveField(21)@JsonKey(fromJson: _toString) String? get type;
...
@useResult
$Res call({
@HiveField(0)@JsonKey(name: 'place_id') String placeId,@HiveField(1) String name,@HiveField(2) String? city,@HiveField(3)@JsonKey(name: 'city_en') String? cityEn,@HiveField(4)@JsonKey(fromJson: _toListOfStrings) List<String>? interests,@HiveField(5) String? category,@HiveField(6)@JsonKey(fromJson: _toDouble) double? price,@HiveField(7)@JsonKey(fromJson: _toDouble) double? cost,@HiveField(8)@JsonKey(fromJson: _toDouble) double? rating,@HiveField(9)@JsonKey(name: 'reviews_count') int? reviewsCount,@HiveField(10) String? address,@HiveField(11) String? description,@HiveField(12)@JsonKey(name: 'photo_url') String? photoUrl,@HiveField(13)@JsonKey(name: 'image_urls', fromJson: _toListOfStrings) List<String>? imageUrls,@HiveField(14)@JsonKey(name: 'opening_hours') String? openingHours,@HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable) double lat,@HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable) double lng,@HiveField(17)@JsonKey(name: 'is_hidden_gem') bool isHiddenGem,@HiveField(18)@JsonKey(name: 'maps_url') String? mapsUrl,@HiveField(19)@JsonKey(fromJson: _toString) String? day,@HiveField(20)@JsonKey(name: 'is_opened', fromJson: _toString) String? isOpened,@HiveField(21)@JsonKey(fromJson: _toString) String? type
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: 'place_id')  String placeId, @HiveField(1)  String name, @HiveField(2)  String? city, @HiveField(3)@JsonKey(name: 'city_en')  String? cityEn, @HiveField(4)@JsonKey(fromJson: _toListOfStrings)  List<String>? interests, @HiveField(5)  String? category, @HiveField(6)@JsonKey(fromJson: _toDouble)  double? price, @HiveField(7)@JsonKey(fromJson: _toDouble)  double? cost, @HiveField(8)@JsonKey(fromJson: _toDouble)  double? rating, @HiveField(9)@JsonKey(name: 'reviews_count')  int? reviewsCount, @HiveField(10)  String? address, @HiveField(11)  String? description, @HiveField(12)@JsonKey(name: 'photo_url')  String? photoUrl, @HiveField(13)@JsonKey(name: 'image_urls', fromJson: _toListOfStrings)  List<String>? imageUrls, @HiveField(14)@JsonKey(name: 'opening_hours')  String? openingHours, @HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable)  double lat, @HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable)  double lng, @HiveField(17)@JsonKey(name: 'is_hidden_gem')  bool isHiddenGem, @HiveField(18)@JsonKey(name: 'maps_url')  String? mapsUrl, @HiveField(19)@JsonKey(fromJson: _toString)  String? day, @HiveField(20)@JsonKey(name: 'is_opened', fromJson: _toString)  String? isOpened, @HiveField(21)@JsonKey(fromJson: _toString)  String? type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaceModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)@JsonKey(name: 'place_id')  String placeId, @HiveField(1)  String name, @HiveField(2)  String? city, @HiveField(3)@JsonKey(name: 'city_en')  String? cityEn, @HiveField(4)@JsonKey(fromJson: _toListOfStrings)  List<String>? interests, @HiveField(5)  String? category, @HiveField(6)@JsonKey(fromJson: _toDouble)  double? price, @HiveField(7)@JsonKey(fromJson: _toDouble)  double? cost, @HiveField(8)@JsonKey(fromJson: _toDouble)  double? rating, @HiveField(9)@JsonKey(name: 'reviews_count')  int? reviewsCount, @HiveField(10)  String? address, @HiveField(11)  String? description, @HiveField(12)@JsonKey(name: 'photo_url')  String? photoUrl, @HiveField(13)@JsonKey(name: 'image_urls', fromJson: _toListOfStrings)  List<String>? imageUrls, @HiveField(14)@JsonKey(name: 'opening_hours')  String? openingHours, @HiveField(15)@JsonKey(fromJson: _toDoubleNonNullable)  double lat, @HiveField(16)@JsonKey(fromJson: _toDoubleNonNullable)  double lng, @HiveField(17)@JsonKey(name: 'is_hidden_gem')  bool isHiddenGem, @HiveField(18)@JsonKey(name: 'maps_url')  String? mapsUrl, @HiveField(19)@JsonKey(fromJson: _toString)  String? day, @HiveField(20)@JsonKey(name: 'is_opened', fromJson: _toString)  String? isOpened, @HiveField(21)@JsonKey(fromJson: _toString)  String? type)  $default,) {final _that = this;
switch (_that) {
case _PlaceModel():
return $default(_that.placeId,_that.name,_that.city,_that.cityEn,_that.interests,_that.category,_that.price,_that.cost,_that.rating,_that.reviewsCount,_that.address,_that.description,_that.photoUrl,_that.imageUrls,_that.openingHours,_that.lat,_that.lng,_that.isHiddenGem,_that.mapsUrl,_that.day,_that.isOpened,_that.type);case _:
  throw StateError('Unexpected subclass');
...
@override@HiveField(19)@JsonKey(fromJson: _toString) final  String? day;
@override@HiveField(20)@JsonKey(name: 'is_opened', fromJson: _toString) final  String? isOpened;
@override@HiveField(21)@JsonKey(fromJson: _toString) final  String? type;
