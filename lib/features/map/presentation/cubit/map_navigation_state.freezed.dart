...
mixin _$MapNavigationState {
 ...
 MapRoute? get activeRoute; bool get isRouteLoading; String? get routeError; NavigationProfile get selectedProfile; int get currentStepIndex;
...
@override
int get hashCode => Object.hash(runtimeType,activeRoute,isRouteLoading,routeError,selectedProfile,currentStepIndex);

@override
String toString() {
  return 'MapNavigationState(activeRoute: $activeRoute, isRouteLoading: $isRouteLoading, routeError: $routeError, selectedProfile: $selectedProfile, currentStepIndex: $currentStepIndex)';
}
...
@useResult
$Res call({
 MapRoute? activeRoute, bool isRouteLoading, String? routeError, NavigationProfile selectedProfile, int currentStepIndex
});
...
/// Create a copy of MapNavigationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activeRoute = freezed,Object? isRouteLoading = null,Object? routeError = freezed,Object? selectedProfile = null,Object? currentStepIndex = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( MapRoute? activeRoute,  bool isRouteLoading,  String? routeError,  NavigationProfile selectedProfile,  int currentStepIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MapNavigationState() when $default != null:
return $default(_that.activeRoute,_that.isRouteLoading,_that.routeError,_that.selectedProfile,_that.currentStepIndex);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( MapRoute? activeRoute,  bool isRouteLoading,  String? routeError,  NavigationProfile selectedProfile,  int currentStepIndex)  $default,) {final _that = this;
switch (_that) {
case _MapNavigationState():
return $default(_that.activeRoute,_that.isRouteLoading,_that.routeError,_that.selectedProfile,_that.currentStepIndex);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( MapRoute? activeRoute,  bool isRouteLoading,  String? routeError,  NavigationProfile selectedProfile,  int currentStepIndex)?  $default,) {final _that = this;
switch (_that) {
case _MapNavigationState() when $default != null:
return $default(_that.activeRoute,_that.isRouteLoading,_that.routeError,_that.selectedProfile,_that.currentStepIndex);case _:
  return null;
...
class _MapNavigationState extends MapNavigationState {
  const _MapNavigationState({this.activeRoute, this.isRouteLoading = false, this.routeError, this.selectedProfile = NavigationProfile.driving, this.currentStepIndex = 0}): super._();
...
/// Create a copy of MapNavigationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? activeRoute = freezed,Object? isRouteLoading = null,Object? routeError = freezed,Object? selectedProfile = null,Object? currentStepIndex = null,}) {
