...
mixin _$AiPlannerState {
 ...
 String? get tripId; AiPlannerStatus get status; String get errorMessage; int get currentPage; int get maxReachedPage; String? get selectedDestination; String get destinationQuery; DateTime? get tripStart; DateTime? get tripEnd; int get adults; int get children; BudgetTierModel? get selectedBudget; String get customBudget; DateTime? get visibleMonth; List<String> get selectedInterests; DateTime get focusedDay;
...
@override
int get hashCode => Object.hash(runtimeType,tripId,status,errorMessage,currentPage,maxReachedPage,selectedDestination,destinationQuery,tripStart,tripEnd,adults,children,selectedBudget,customBudget,visibleMonth,const DeepCollectionEquality().hash(selectedInterests),focusedDay);

@override
String toString() {
  return 'AiPlannerState(tripId: $tripId, status: $status, errorMessage: $errorMessage, currentPage: $currentPage, maxReachedPage: $maxReachedPage, selectedDestination: $selectedDestination, destinationQuery: $destinationQuery, tripStart: $tripStart, tripEnd: $tripEnd, adults: $adults, children: $children, selectedBudget: $selectedBudget, customBudget: $customBudget, visibleMonth: $visibleMonth, selectedInterests: $selectedInterests, focusedDay: $focusedDay)';
}
...
/// Create a copy of AiPlannerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tripId = freezed,Object? status = null,Object? errorMessage = null,Object? currentPage = null,Object? maxReachedPage = null,Object? selectedDestination = freezed,Object? destinationQuery = null,Object? tripStart = freezed,Object? tripEnd = freezed,Object? adults = null,Object? children = null,Object? selectedBudget = freezed,Object? customBudget = null,Object? visibleMonth = freezed,Object? selectedInterests = null,Object? focusedDay = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? tripId,  AiPlannerStatus status,  String errorMessage,  int currentPage,  int maxReachedPage,  String? selectedDestination,  String destinationQuery,  DateTime? tripStart,  DateTime? tripEnd,  int adults,  int children,  BudgetTierModel? selectedBudget,  String customBudget,  DateTime? visibleMonth,  List<String> selectedInterests,  DateTime focusedDay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiPlannerState() when $default != null:
return $default(_that.tripId,_that.status,_that.errorMessage,_that.currentPage,_that.maxReachedPage,_that.selectedDestination,_that.destinationQuery,_that.tripStart,_that.tripEnd,_that.adults,_that.children,_that.selectedBudget,_that.customBudget,_that.visibleMonth,_that.selectedInterests,_that.focusedDay);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? tripId,  AiPlannerStatus status,  String errorMessage,  int currentPage,  int maxReachedPage,  String? selectedDestination,  String destinationQuery,  DateTime? tripStart,  DateTime? tripEnd,  int adults,  int children,  BudgetTierModel? selectedBudget,  String customBudget,  DateTime? visibleMonth,  List<String> selectedInterests,  DateTime focusedDay)  $default,) {final _that = this;
switch (_that) {
case _AiPlannerState():
return $default(_that.tripId,_that.status,_that.errorMessage,_that.currentPage,_that.maxReachedPage,_that.selectedDestination,_that.destinationQuery,_that.tripStart,_that.tripEnd,_that.adults,_that.children,_that.selectedBudget,_that.customBudget,_that.visibleMonth,_that.selectedInterests,_that.focusedDay);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? tripId,  AiPlannerStatus status,  String errorMessage,  int currentPage,  int maxReachedPage,  String? selectedDestination,  String destinationQuery,  DateTime? tripStart,  DateTime? tripEnd,  int adults,  int children,  BudgetTierModel? selectedBudget,  String customBudget,  DateTime? visibleMonth,  List<String> selectedInterests,  DateTime focusedDay)?  $default,) {final _that = this;
switch (_that) {
case _AiPlannerState() when $default != null:
return $default(_that.tripId,_that.status,_that.errorMessage,_that.currentPage,_that.maxReachedPage,_that.selectedDestination,_that.destinationQuery,_that.tripStart,_that.tripEnd,_that.adults,_that.children,_that.selectedBudget,_that.customBudget,_that.visibleMonth,_that.selectedInterests,_that.focusedDay);case _:
  return null;
...
class _AiPlannerState extends AiPlannerState {
  const _AiPlannerState({this.tripId, this.status = AiPlannerStatus.initial, this.errorMessage = '', this.currentPage = 0, this.maxReachedPage = 0, this.selectedDestination, this.destinationQuery = '', this.tripStart, this.tripEnd, this.adults = 0, this.children = 0, this.selectedBudget, this.customBudget = '', this.visibleMonth, final  List<String> selectedInterests = const <String>[], required this.focusedDay}): _selectedInterests = selectedInterests,super._();
...
@override
int get hashCode => Object.hash(runtimeType,tripId,status,errorMessage,currentPage,maxReachedPage,selectedDestination,destinationQuery,tripStart,tripEnd,adults,children,selectedBudget,customBudget,visibleMonth,const DeepCollectionEquality().hash(_selectedInterests),focusedDay);
...
/// Create a copy of AiPlannerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tripId = freezed,Object? status = null,Object? errorMessage = null,Object? currentPage = null,Object? maxReachedPage = null,Object? selectedDestination = freezed,Object? destinationQuery = null,Object? tripStart = freezed,Object? tripEnd = freezed,Object? adults = null,Object? children = null,Object? selectedBudget = freezed,Object? customBudget = null,Object? visibleMonth = freezed,Object? selectedInterests = null,Object? focusedDay = null,}) {
